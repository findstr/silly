...
当前滚动进度（2026-08-13）：底层 engine/socket、TCP/UDP/addr、DNS、TLS/OpenSSL、HTTP common/HTTP1、HTTP/2/HPACK、WebSocket、gRPC与Redis阶段已收口；共296项（P1 106、P2 163、P3 27）。当前审计MySQL，新增`MYSQL-020`、`MYSQLC-008`、`DOC-027/028`后继续codec/认证/池/文档收口；etcd随后复核。
