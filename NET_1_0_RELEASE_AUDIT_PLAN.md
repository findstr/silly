...
当前滚动进度（2026-08-13）：底层 engine/socket、TCP/UDP/addr、DNS、TLS/OpenSSL、HTTP common/HTTP1、HTTP/2/HPACK、WebSocket、gRPC与Redis阶段已收口；共302项（P1 108、P2 164、P3 30）。当前审计MySQL，新增`MYSQL-020`、`MYSQLC-008`、`DOC-027`至`DOC-034`后继续codec/认证/池/文档收口；etcd随后复核。
