...
- 专项另确认2项分支独有问题：`CLUSTER-B001`（P2，eager `cluster.connect`没有deadline/cancel参数且未向底层传timeout）和`CLUSTER-B002`（P3，logging/trace/errno中英文文档仍使用已删除的旧cluster API）；不计入master基线199项统计。
