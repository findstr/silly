...
| `lualib/silly/metrics/prometheus.lua` | 已审有归档 | METRIC-001至004/007至009 | registration、family formatting、异常收尾与collectors |
...
| `test/testprometheus.lua` | 已审有归档 | METRIC-001至009、CORE-008 | counter/gauge/histogram/registry正常路径与wire/异常盲区 |
...
| `docs/src/en/reference/metrics/collector.md` | 审阅中 | CORE-008、METRIC-003/005/009 | custom collector、异常与内置字段继续复核 |
...
| `docs/src/en/reference/metrics/prometheus.md` | 审阅中 | METRIC-001至009、CORE-008、DOC-051/054 | constructor/gather/HTTP examples |
| `docs/src/en/reference/metrics/registry.md` | 审阅中 | METRIC-004/009 | duplicate family与custom collector |
...
| `docs/src/reference/metrics/collector.md` | 审阅中 | CORE-008、METRIC-003/005/009 | custom collector、异常与内置字段继续复核 |
...
| `docs/src/reference/metrics/prometheus.md` | 审阅中 | METRIC-001至009、CORE-008、DOC-051/054 | constructor/gather/HTTP examples |
| `docs/src/reference/metrics/registry.md` | 审阅中 | METRIC-004/009 | duplicate family与custom collector |
