...
---malformed question name, RR count overflow, or unresolvable records).
---ancount: -1 = TC (truncated), 0 = rcode!=0 or no answers, >0 = normal.
---@param msg string  full DNS response packet
---@return integer id, string name, integer qtype, integer ancount, {[1]:string, [2]:integer, [3]:integer, [4]:(string|table)?}[]? records
