...
---@param stream silly.net.http.h1.stream.client
...
---@param stream silly.net.http.h1.stream.client|silly.net.http.h1.stream.client
...
function M.connect(url, header)
	...
	local stream = h1.newstream(scheme, conn, addr)
